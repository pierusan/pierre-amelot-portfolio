...
export function registerLessonsLearnedRevealAnimation(
  ...
  const introParagraphWordHighlightTween = gsap.to(splitIntroParagraph.words, {
    color: textColorMain,
    duration: 1,
    stagger: 1,
    scrollTrigger: {
  ...
  // Pass animation to store so that the 3D scene camera can add sync to it
