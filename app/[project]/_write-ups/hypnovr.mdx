...
recovery and reduces side effects, its adoption remains limited. It is
time-consuming and tiring for anesthesiologist. They have to constantly talk to
...
<ProjectImage name="hypnovr_4_2_my_responsibility" />

## Process

<ProjectImage
  name="hypnovr_5_sequence_flow_diagram"
  caption="Sequence flow diagram from interviews of anesthesiologists"
/>
