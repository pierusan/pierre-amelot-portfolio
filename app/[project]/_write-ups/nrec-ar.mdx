...
University), _I developed a Unity AR app to help deminers get instant feedback on
their technique_. I rapidly iterated over prototypes across a variety of hardware
and libraries, culminating in a HoloLens app overlaying the detector's motion
information directly on the ground.
...
When I joined NREC in 2017, the team had already built a [custom piece of
hardware](https://www.nrec.ri.cmu.edu/nrec/solutions/defense/other-projects/sweep-monitoring.html)
